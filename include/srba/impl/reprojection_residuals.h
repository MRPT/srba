...
double RbaEngine<RBA_SETTINGS_T>::reprojection_residuals(
	...
	) const
{
	...
	for (size_t i=0;i<nObs;i++)
	{
		...
		RBA_SETTINGS_T::sensor_pose_on_robot_t::pose_robot2sensor( *base_pose_wrt_observer, base_pose_wrt_sensor, this->parameters.sensor_pose );
